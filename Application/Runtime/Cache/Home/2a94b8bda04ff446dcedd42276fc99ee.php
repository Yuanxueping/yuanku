...
<!-- 这里写自己页面的样式 -->
<!--HOME css-->
<script src="/lidong_clone/yuanku/Public/js/headerchange.js"></script>
		      ...
		      <a class="navbar-brand" href="#">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav navbar-right color">
				        <li><a href="/lidong_clone/yuanku/index.php/Home/Index/index">首页</a></li>
				        <li>
				        <a href="
				        	<?php if(isset($_SESSION['username'])) {echo '/lidong_clone/yuanku/index.php/Home/Personal/index';} else{ echo '/lidong_clone/yuanku/index.php/Home/Index/login'; } ?>
				        ">
				        ...
				        <li>
				        	<a href="
				        		<?php if(isset($_SESSION['username'])) {echo '/lidong_clone/yuanku/index.php/Home/Personal/logout';} else{ echo '/lidong_clone/yuanku/index.php/Home/Index/register'; } ?>
				        	">
				        ...
				        <li><a href="/lidong_clone/yuanku/index.php/Home/Index/personal">个人中心</a></li>
...
<div class="bs-example" data-example-id="carousel-with-captions">
	    <div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
	      ...
	      <div class="carousel-inner" role="listbox">
	        <div class="item">
	        	<img src="/lidong_clone/yuanku/Public/img/lunbo/01.jpg"/>			          
	        </div>
	        <div class="item">
	        	<img src="/lidong_clone/yuanku/Public/img/lunbo/02.jpg"/>
	          
	        </div>
	        <div class="item active">
	        	<img src="/lidong_clone/yuanku/Public/img/lunbo/03.jpg"/>
				...
				<div class="container">
					<div class="row" >
						...
						<div class="col-lg-3 col-md-6 col-lg-12">
							<ul >
								<li><h4>最新动态</h4></li><br/>
								<li><a href="#"><img src="/lidong_clone/yuanku/Public/img/highstand homepage/2h1BK2H2Quk (1).jpg"/>捕鱼</a></li><br/>
								<li><a href="#"><img src="/lidong_clone/yuanku/Public/img/highstand homepage/2h1BK2H2Quk (1).jpg"/>钓鱼</a></li><br/>
								<li><a href="#"><img src="/lidong_clone/yuanku/Public/img/highstand homepage/2h1BK2H2Quk (1).jpg"/>抓鱼</a></li><br/>
