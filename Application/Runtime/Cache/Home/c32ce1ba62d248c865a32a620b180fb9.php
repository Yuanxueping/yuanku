							...
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="kitty">
										...
										<img width="140px" height="140px" src="/1001/clone_two/yuanku/<?php echo ($head_photo); ?>"/>
										<ul class="clearfix">
											<li><b><a href=""><?php echo (session('username')); ?></a></b></li>
											<li id="sayhello">1</li>
											<li><a href="/1001/clone_two/yuanku/index.php/Home/Index/edit_message">修改个人信息</a>&nbsp;<img src="/1001/clone_two/yuanku/Public/img/personal/矩形-18-拷贝.png"/></li>
										</ul>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 col-xs-12">
									...
									<div class="row">
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="product">
												<table border="0px" cellspacing="0px" cellpadding="0px">
													<tr>
														<td rowspan="2"><img src="/1001/clone_two/yuanku/Public/img/personal/椭圆-3.png"/></td>
														<td>&nbsp;订阅的文章：&nbsp;<span>0</span></td>
													</tr>
													<tr>
														<td>&nbsp;<a href="">查看已订阅的文章</a>&nbsp;<img src="/1001/clone_two/yuanku/Public/img/personal/矩形-10-拷贝.png"/></td>												
													</tr>
												</table>
											</div>
										</div>
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="product">
												<table border="0px" cellspacing="0px" cellpadding="0px">
													<tr>
														<td rowspan="2"><img src="/1001/clone_two/yuanku/Public/img/personal/椭圆-4-拷贝.png"/></td>
														<td>&nbsp;我的浏览足迹：&nbsp;<span>0</span></td>
													</tr>
													<tr>
														<td>&nbsp;<a href="">查看浏览足迹</a>&nbsp;<img src="/1001/clone_two/yuanku/Public/img/personal/矩形-10-拷贝.png"/></td>												
													</tr>
												</table>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="product">
												<table border="0px" cellspacing="0px" cellpadding="0px">
													<tr>
														<td rowspan="2"><img src="/1001/clone_two/yuanku/Public/img/personal/矩形-20-拷贝-3.png"/></td>
														<td>&nbsp;我发布的文章&nbsp;<span>0</span></td>
													</tr>
													<tr>
														<td>&nbsp;<a href="">查看我发布的文章</a>&nbsp;<img src="/1001/clone_two/yuanku/Public/img/personal/矩形-10-拷贝.png"/></td>												
													</tr>
												</table>
											</div>
										</div>
										<div class="col-md-6 col-sm-12 col-xs-12">
											<div class="product">
												<table border="0px" cellspacing="0px" cellpadding="0px">
													<tr>
														<td rowspan="2"><img src="/1001/clone_two/yuanku/Public/img/personal/矩形-20-拷贝.png"/></td>
														<td>&nbsp;喜欢的文章：&nbsp;<span>0</span></td>
													</tr>
													<tr>
														<td>&nbsp;<a href="">查看喜欢的文章</a>&nbsp;<img src="/1001/clone_two/yuanku/Public/img/personal/矩形-10-拷贝.png"/></td>												
													</tr>
												</table>
											</div>
										</div>
