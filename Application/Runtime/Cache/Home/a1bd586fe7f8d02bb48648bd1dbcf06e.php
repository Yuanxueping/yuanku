		      ...
		      <a class="navbar-brand" href="#">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav navbar-right color">
				        ...
				        <li>
				        <a href="
				        	<?php if(isset($_SESSION['username'])) {echo '/yuanku/index.php/Home/Personal';} else{ echo '/yuanku/index.php/Home/Index'; } ?>
				        ">
		            	...
		            	<div class="content"> 
							 ...
							 <form action="/yuanku/index.php/Home/Personal/update" method="post" class="form_wd_23" enctype="multipart/form-data" class="form_wd_23">
							 	<div class="form-group">
							 		...
							 		<input class="form-control" name="user_name" disabled="disabled" value="<?php echo (session('username')); ?>">
							 	</div>
							 	<div class="form-group">
