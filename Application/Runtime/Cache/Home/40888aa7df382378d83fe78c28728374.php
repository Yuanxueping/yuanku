		...
		<div class="container-fluid">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="banner" style="background-image: url(/yuanku/Public/img/01.jpg);">
						<div class="container">
							...
							<h3>Storytelling fused with technology and design of Highsta.</h3>						
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 green_center">
					...
					<p>Many web sites still in their infancy versions have evolve
        				over the years Ipsum generators on the internet.</p>
					<ul>
				        <li>Corporate</li>
				        <li>Portfolio</li>
				        <li>Agency</li>
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 right_black">
					<h3>Professional Clean Creative Featured Site Let's Start a Great <strong>Project Now !</strong></h3>
					<a href="#"><button type="button" class="btn btn-success btn-block">Success</button></a>
				</div>
			</div>
			<div class="height_90">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 say_title">
					<h3 class="">What Our People Says </h3>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 people_say">
