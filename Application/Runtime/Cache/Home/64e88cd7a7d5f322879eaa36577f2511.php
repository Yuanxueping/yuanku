					    ...
					    <div class="people">
							  <div class="basic-info">
							    ...
							    <ul class="clearfix" >
									...
									<li id="sayhello">1</li>
									<br>
									<li><a href="/yuanku/index.php/Home/Index/edit_message">修改个人信息</a>&nbsp;<img src="/yuanku/Public/img/personal/矩形-18-拷贝.png"/></li>
								</ul>
							  ...
							  <div class="user-stats">
								  <ul class="clearfix" >
								    ...
								    <i class="glyphicon glyphicon-pencil"></i>
								      <a href="/yuanku/index.php/Home/Index/write_article"><span>写文章</span></a>
								    </li>
								    <!-- <li>
	          ...
	          <div class="col-xs-12 col-sm-9 content">
	            <div class="panel panel-default">
	              <div class="panel-heading">
	                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a>订阅的文章</h3>
	              </div>
