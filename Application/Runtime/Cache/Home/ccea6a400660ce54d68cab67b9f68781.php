	...
	<nav class="navbar navbar-default top-nav navbar-fixed-top gaise">
		...
		<div class="container  box">
			<div class="col-lg-offset-3 col-lg-6 col-md-12">
				<form class="form-signin" role="form" action="/clone/yuanku/index.php/Home/Login/checkLogin" method="POST" enctype="application/x-www-form-urlencoded">
			        ...
			        <div class="form-group">
			        	<p class="form-signin-heading"><img src="/clone/yuanku/Public/img/login/user.png"/>&nbsp;用户名/邮箱</p>
			        ...
			        <div class="form-group" style="margin-top:0px;">
						<p class="form-signin-heading" style="margin-top:0px;"><img src="/clone/yuanku/Public/img/login/pwd.png"/>&nbsp;密码</p>
			          <div class="input-group">
