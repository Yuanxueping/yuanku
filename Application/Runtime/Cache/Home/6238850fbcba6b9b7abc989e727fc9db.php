		      ...
		      <a class="navbar-brand" href="#">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav navbar-right color">
				        ...
				        <li>
				        <a href="
				        	<?php if(isset($_SESSION['username'])) {echo '/yuanku/index.php/Home/Personal';} else{ echo '/yuanku/index.php/Home/Index/login'; } ?>
				        ">
				        <?php  if(isset($_SESSION['username'])){ echo $_SESSION['username']; }else{ echo '登陆'; } ?>
				        </a>
				        </li>
				        <li><a href="/yuanku/index.php/Home/Personal/register">注册</a></li>
		               ...
		               <div class="personal-right">
							<div class="row">
								<div class="col-md-6 col-sm-12 col-xs-12">
									<div class="kitty">
										<img src="/yuanku/Public/head_logo/default_head_logo.jpg"/>
										<ul class="clearfix">
											<li><b><a href="">Kitty</a></b></li>
											<li>早上好~</a></li>
											<li><a href="/yuanku/index.php/Home/Personal/edit_user_info.html">修改个人信息</a>&nbsp;<img src="<?php echo ($head_logo); ?>"/></li>
										</ul>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 col-xs-12">
