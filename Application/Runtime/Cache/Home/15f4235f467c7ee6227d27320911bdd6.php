...
<link rel="stylesheet" href="/thinkphp_3.2.3_full/yuanku/Public/css/home/sport_nba.css" />
<!--0-->
  </head>
<body>
		      ...
		      <a class="navbar-brand" href="#">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      <ul class="nav navbar-nav navbar-right color">
				        ...
				        <li><a href="/thinkphp_3.2.3_full/yuanku/index.php/Home/Nba/news">推荐</a></li>
				        <li><a href="/thinkphp_3.2.3_full/yuanku/index.php/Home/Nba/news">视频</a></li>
				        <li><a href="<?php echo U('Nba/index');?>">篮球</a></li>
				        <li><a href="/thinkphp_3.2.3_full/yuanku/index.php/Home/Nba/news">足球</a></li>
				        <li>
				        <a href="
				        ...
				        <!-- 
				        <li><a href="/thinkphp_3.2.3_full/yuanku/index.php/Home/Nba/contact_us">联系我们</a></li>
				        <li><a href="/thinkphp_3.2.3_full/yuanku/index.php/Home/Nba/about_us">关于我们</a></li> -->
                    ...
                    <ul class="cf" data-loaded="true" style="display: block;">
                        <li>
                            <a class="player-1" href="http://nba.stats.qq.com/player/jump.htm?id=jonas_valanciunas">
                                ...
                                <div class="photo">
                                    <img onerror="this.onerror=null; this.src=bestPlayerReplaceImg.big;" src="/thinkphp_3.2.3_full/yuanku/Public/img/126115995.png" alt="220x350"></div>
                            </a>
                            <a class="player-2" href="http://nba.stats.qq.com/player/jump.htm?id=anthony_davis">
                                <div class="rank">2</div>
                                <div class="photo">
                                    <img  src="/thinkphp_3.2.3_full/yuanku/Public/img/126116230.png" alt="132x132"></div>
                                <div class="name">
                                    <p>安东尼-戴维斯</p>
                                    <span>前锋-中锋 /  鹈鹕</span>
                                </div>
