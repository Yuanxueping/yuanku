	            ...
	            <div class="panel panel-default">
	              ...
	              <div class="panel-body" style="margin-bottom:10%;">
		            	<div class="content"> 
							 ...
							 <form action="<?php echo U('Personal/update');?>" method="post" class="form_wd_23" enctype="multipart/form-data" class="form_wd_23">
							 	...
							 	<div class="form-group">
							 		...
							 		<input class="form-control" type="password" name="user_pwd" value="<?php echo ($client_info["user_pwd"]); ?>">
							 	</div>
							 	<div class="form-group">

							 		<label class="control-label">邮箱</label>
							 		<input class="form-control" name="email_address" value="<?php echo ($client_info["email_address"]); ?>">
							 	</div>
							 	<div class="form-group">

							 		<label class="control-label">头像</label>
							 		<input class="dropify"  name="head_photo" data-default-file="/yuanku/<?php echo ($client_info["head_photo"]); ?>" type="file">
							 	</div>
