  ...
  <ul class="nav metismenu">
    <li class="profile-sidebar-container">
      <div class="profile-sidebar text-center">
        <div class="profile-userpic">
          <img src="/yuanku/Public/images/admin/profile_user.jpg" class="img-responsive img-circle center-block mCS_img_loaded" alt="user">
    ...
    <li class="">
      ...
      <ul class="nav nav-inside collapse" aria-expanded="false" style="height: 0px;">
        ...
        <li><a href="/yuanku/admin/system">网站设置</a></li>
        <li><a href="/yuanku/admin/system/manager_user">管理员设置</a></li>
      </ul>
    </li>
        <li>
    ...
    <li>
      ...
      <ul class="nav nav-inside collapse" aria-expanded="false">
        ...
        <li><a href="/yuanku/admin/news/index">新闻列表</a></li>
        <li><a href="/yuanku/admin/news/add">添加新闻</a></li>
