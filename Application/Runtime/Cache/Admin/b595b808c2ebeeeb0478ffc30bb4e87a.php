 ...
 <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="content-box p-20 twitter white f-s-16">
            <img src="/clone/yuanku/Public/images/admin/avatar.png" class="pull-left m-r-10 mCS_img_loaded" alt="avatar">
         ...
         <div class="col-lg-3 col-md-6">
          <div class="content-box p-20 soundcloud white f-s-16">
            <img src="/clone/yuanku/Public/images/admin/avatar4.png" class="pull-left m-r-10 mCS_img_loaded" alt="avatar">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="content-box p-20 facebook white f-s-16">
              <img src="/clone/yuanku/Public/images/admin/avatar2.png" class="pull-left m-r-10 mCS_img_loaded" alt="avatar">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="content-box p-20 gplus white f-s-16">
            <img src="/clone/yuanku/Public/images/admin/avatar3.png" class="pull-left m-r-10 mCS_img_loaded" alt="avatar">
