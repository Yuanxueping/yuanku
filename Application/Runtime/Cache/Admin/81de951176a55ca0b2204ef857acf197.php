	...
	<div class="panel-body">
		<form role="form" class="form-horizontal" method="post" action="<?php echo U('News/news_edit');?>" enctype="multipart/form-data">
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<select name="author_id" class="form-control" required="" id="author">
	            		...
	            		<?php if(is_array($author_list)): $i = 0; $__LIST__ = $author_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['id'] == $news_info[0]['author_id']): ?><option value="<?php echo ($vo['id']); ?>" selected="selected"><?php echo ($vo['name']); ?></option>
	            			<?php else: ?>
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<input class="dropify form-control"  name="img" type="file" id="img" data-default-file="/clone/yuanku/Public/<?php echo ($news_info[0]['img']); ?>">
	          	</div>
	        </div>
	        <div class="form-group">
