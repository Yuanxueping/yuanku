...
<link rel="stylesheet" type="text/css" href="/lidong_clone/yuanku/Public/css/admin/news_add.css"/>
	...
	<div class="panel-body">
		<form role="form" class="form-horizontal" method="post" action="<?php echo U('News/news_add');?>" enctype="multipart/form-data">
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<input class="dropify form-control"  name="img" type="file" id="img" data-default-file="/lidong_clone/yuanku/Public/<?php echo ($news_info[0]['img']); ?>">
	          	</div>
	        </div>
	        <div class="form-group">
...
<!-- 配置文件 -->
<script type="text/javascript" src="/lidong_clone/yuanku/Public/lib/ueditor/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript" src="/lidong_clone/yuanku/Public/lib/ueditor/ueditor.all.min.js"></script>
<!-- 实例化编辑器 -->
...
<script src="/lidong_clone/yuanku/Public/js/admin/news_add.js"></script>