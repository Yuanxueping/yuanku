...
>>>>>>> 466992f59f91f20101d86cd96dc6adcb80ea7edc
 ...
 <form action="<?php echo U('System/user_edit');?>" method="post" class="form_wd_23" enctype="multipart/form-data">
 	...
 	<div class="form-group">
 		...
 		<input class="dropify" name="head_photo" data-default-file="/thinkphp_3.2.3_full/yuanku/uploads<?php echo ($user_info["head_photo"]); ?>" type="file"></div>
...
<script src="/thinkphp_3.2.3_full/yuanku/Public/js/demo-switch.js">
</script>
<script>
