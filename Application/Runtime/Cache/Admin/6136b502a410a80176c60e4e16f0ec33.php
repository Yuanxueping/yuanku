...
<div id="preloader" style="height: 631px; display: none;">
 ...
 <div class="navbar-header container brand-orange">
   ...
   <a href="/yuanku/admin" class="logo"><img src="Pacificonis%20-%20Dashboard_files/logo.png" alt="力动企业" class="mCS_img_loaded"></a>
  ...
  <ul class="nav metismenu">
    ...
    <li>
      ...
      <ul class="nav nav-inside collapse" aria-expanded="false">
        ...
        <li><a href="<?php echo U('news/category');?>">新闻分类</a></li>
...
<div class="side-panel">
 ...
 <form action="<?php echo U('System/user_edit');?>" method="post" class="form_wd_23" enctype="multipart/form-data">
 	<div class="form-group">
 		...
 		<br><?php echo ($user_info["user_name"]); ?></div>
 	<div class="form-group">
 		<label class="control-label">密码</label>
 		<input class="form-control" name="user_pwd" value="<?php echo ($user_info["user_pwd"]); ?>"></div>
 	<div class="form-group">
 		<label class="control-label">头像</label>

 		<input class="dropify" name="head_photo" data-default-file="/yuanku/uploads<?php echo ($user_info["head_photo"]); ?>" type="file"></div>
 	<button class="btn btn-success">提交</button>

 	<input type="hidden"  name="id" value="<?php echo ($user_info["id"]); ?>"></form>
