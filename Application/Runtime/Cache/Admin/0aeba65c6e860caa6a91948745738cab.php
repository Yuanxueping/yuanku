      	...
      	<tbody>
      		<?php if(is_array($news_list)): $k = 0; $__LIST__ = $news_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
					...
					<td class="text-center">
						<div class="btn-group">
							<button type="button" class="btn btn-success btn-xs"><a style="color:white;" href="/yuanku/index.php/Admin/News/author_update/nid/<?php echo ($vo["nid"]); ?>"><span class="glyphicon glyphicon-pencil"></span></a></button>
							<button type="button" class="btn btn-danger btn-xs"><a style="color:white;" href="/yuanku/index.php/Admin/News/author_del/nid/<?php echo ($vo["nid"]); ?>" onclick="return confirm('确定删除吗？')"><span class="glyphicon glyphicon-trash"></span></a></button>
						</div>
					</td>
