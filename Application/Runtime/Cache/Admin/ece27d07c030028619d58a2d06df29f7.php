...
=======
<link rel="stylesheet" type="text/css" href="/thinkphp_3.2.3_full/yuanku/Public/css/admin/news_add.css"/>
>>>>>>> 524601d91634b83468b87deb6b29c8db3c7fc866
	...
	<div class="panel-body">
		<form role="form" class="form-horizontal">
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<select name="author" class="form-control" required="" id="author">
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<select name="news_sort" class="form-control" required="" id="news_sort">
	        ...
	        <div class="form-group">
	          	...
	          	<div class="col-md-10">
	            	<textarea required="" class="form-control" placeholder="新闻内容" rows="10" cols="30" id="content" name="content"></textarea>
	          	</div>
	        </div>
	        <div class="form-group">
...
<script src="/thinkphp_3.2.3_full/yuanku/Public/js/admin/news_add.js"></script>
>>>>>>> 524601d91634b83468b87deb6b29c8db3c7fc866
