...
<div class="table-responsive alt-table feedback_list">
    ...
    <tbody> 
      <?php if(is_array($fb_list)): $i = 0; $__LIST__ = $fb_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fb_i): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td class="text-center">
            <div class="btn-group">
              <button onclick="location.href='<?php echo U('Client/feedback',array('fb_id'=>$fb_i[fb_id]));?>'" type="button" class="btn btn-success waves-effect"><i class="zmdi zmdi-eye"></i></button>
              <button onclick="location.href='<?php echo U('Client/feedback_del',array('fb_id'=>$fb_i[fb_id]));?>'" type="button" class="btn btn-danger waves-effect"><i class="zmdi zmdi-delete"></i></button>
            </div>
          </td>
