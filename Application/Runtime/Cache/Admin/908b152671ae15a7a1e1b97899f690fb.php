...
<div class="side-panel">
 ...
 <form action="<?php echo U('Client/client_edit');?>" method="post" class="form_wd_23" enctype="multipart/form-data">
 	<div class="form-group">
 		<label class="control-label">用户名</label>
 		<br><?php echo ($client_info["user_name"]); ?></div>
 	<div class="form-group">
 		<label class="control-label">密码</label>
 		<input class="form-control" name="user_pwd" value="<?php echo ($client_info["user_pwd"]); ?>"></div>
 	<div class="form-group">
